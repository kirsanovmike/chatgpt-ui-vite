  ...
  <v-footer app class="chat-footer">
    <div class="chat-footer-shell">
      <div class="liquidGlass-wrapper liquidGlass-wrapper--lg chat-footer-glass">
        ...
        <div class="liquidGlass-text chat-footer-content d-flex flex-column">
          <!-- Левый блок: активный системный промпт + кнопка промптов -->
          <div class="chat-footer-left" style="width: 100%">
            <div
                v-if="systemPrompt"
...
import {systemPrompts, readyPrompts} from "@/data/prompts/prompts.ts"
